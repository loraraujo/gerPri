                                    ...
                                    <tbody>
                                        ...
                                        ?>
                                            <tr>
                                                ...
                                                <td><?php echo utf8_encode($curso); ?></td>
                                                <td style="text-align:center;"><?php echo $modulo; ?></td>

                                                <td><a class="btn btn-primary" href="alterar_aluno.php?alu_codigo=<?php echo $codigo_aluno; ?>" onclick="">
                                                        Alterar
                                                    </a></td>

                                                <td> <a class="btn btn-danger" href="excluir_aluno.php?alu_codigo=<?php echo $codigo_aluno; ?>" onclick=" return confirm('Tem certeza que deseja excluir?');">
                                                        Excluir</a> </td>
                                            </tr>
