                                    ...
                                    <tbody>
                                        ...
                                        ?>
                                            <tr>
                                                ...
                                                <td><a class="btn btn-primary" href="alterar_curso.php?cur_codigo=<?php echo $codigo_curso; ?>" onclick="">
                                                        Alterar
                                                    </a></td>

                                                <td> <a class="btn btn-danger" href="excluir_curso.php?cur_codigo=<?php echo $codigo_curso; ?>" onclick=" return confirm('Tem certeza que deseja excluir?');">
                                                        Excluir</a> </td>
                                            </tr>
                                        <?php
                                        }
